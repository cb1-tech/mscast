...
bash $R 183_permissions_and_kickoff 184_demo_coherence 185_pf_b8_a5 186_demo_watermark 187_brm_control
...
Rebuild finished. Manual steps that remain:
  ...
  2. Re-check the harness above - it should read 29 PASS, 2 WARN, 0 FAIL of 31.
